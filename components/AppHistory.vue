    ...
    <div v-swiper:historySwiper="swiperOption" class="my-swiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="(item, index) in items" :key="index">
          ...
          <svg v-if="index === 0" @click="moveToNext" class="arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="58.001px" height="58px" viewBox="0 0 58.001 58" enable-background="new 0 0 58.001 58" xml:space="preserve">
          ...
          <svg v-if="index === 1" @click="moveToNext" class="arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="58.001px" height="58px" viewBox="0 0 58.001 58" enable-background="new 0 0 58.001 58" xml:space="preserve">
            <path fill="#FFFFFF" d="M29,6.098C16.373,6.098,6.098,16.371,6.098,29c0,12.628,10.274,22.901,22.902,22.901  S51.903,41.628,51.903,29C51.903,16.371,41.628,6.098,29,6.098z"/>
            <g>
              <g>
          ...
          <svg v-if="index === 2" @click="moveToNext" class="arrow" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="58.001px" height="58px" viewBox="0 0 58.001 58" enable-background="new 0 0 58.001 58" xml:space="preserve">
