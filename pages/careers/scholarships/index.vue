...
<script>
  ...
  export default {
    ...
    asyncData({}) {
      return axios.get('http://new.walter.ba/cms/wp-json/wp/v2/pages/68').then((response) => {
  ...
  methods: {
    ...
    getItems() {
      axios.get('http://new.walter.ba/cms/wp-json/wp/v2/scholarships?per_page=100&_embed').then((response) => {
