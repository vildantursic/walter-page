  ...
  <section class="padded-content footing-space">
    ...
    <div class="no-items">
      <h1 v-if="searchedList.length === 0 && !loading">
        There are no open courses right now but there certainly are some in the making. Keep in touch on <a href="https://www.facebook.com/walterBIM/">Facebook</a> and <a href="https://www.linkedin.com/company/walter-bim-solutions/">Linkedin</a> and be the first to know when they are ready.
      </h1>
